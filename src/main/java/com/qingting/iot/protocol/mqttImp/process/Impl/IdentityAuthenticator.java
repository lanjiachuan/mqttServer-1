package com.qingting.iot.protocol.mqttImp.process.Impl;

import java.sql.PreparedStatement;
import java.sql.ResultSet;

import com.alibaba.druid.pool.DruidPooledConnection;
import com.qingting.iot.protocol.mqttImp.process.Impl.dataHandler.DBConnection;
...
public class IdentityAuthenticator implements IAuthenticator {
	...
	public boolean checkValid(String username, String password) {
		...
		try {
			...
			String sqlString="select * from iot_server where username=? and password=?";
