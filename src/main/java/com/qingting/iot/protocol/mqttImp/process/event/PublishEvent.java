package com.qingting.iot.protocol.mqttImp.process.event;
...
public class PublishEvent implements Serializable{
	...
	public String toString() {
		return "PublishEvent [topic=" + topic + ", qos=" + qos + ", message=" + Arrays.toString(message) + ", retain="
				+ retain + ", clientID=" + clientID + ", packgeID=" + packgeID + "]";
	}
